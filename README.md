...
- Welcome to an engaging tutorial designed to walk you through building a AI-agent for financial analysis. Learn how to leverage LlamaIndex to build AI agents with LLM, to perform detailed stock analysis and generate financial analysis.
## Architecture
![Stock Name (2)](https://github.com/user-attachments/assets/fe49c3d5-a962-4f1c-989d-1ff7e7adaccf)
---
## Prerequisites
                  ...
                  "inputs": [
                              {
                                  ...
                                  "data": [
                                      "Give me a complete Analysis of Apple stock"
                                  ],
                                  "datatype": "BYTES"
                              }
                          ]  
